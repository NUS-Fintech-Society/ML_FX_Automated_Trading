...
class AdaBoost:
    ...
    def start_training(self):
        ...
        ada1 = AdaBoostClassifier(base_estimator = DecisionTreeClassifier(criterion = "entropy", max_depth = 4), n_estimators = 700, learning_rate = 0.2)
        ada1.fit(X_train,y_train)
        ada1_pred_class = ada1.predict(X_test)
        accuracy = metrics.accuracy_score(y_test, ada1_pred_class)
